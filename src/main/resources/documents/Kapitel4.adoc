...
[.text-justify]
Beim Refactoring wird der Code umstrukturieren, ohne seine Funktionalität zu verändern.
...
Wenn man etwas falsch macht, ist es sehr wahrscheinlich, dass der grüne Balken auf rot wechselt und einen sofort darauf hinweist, dass etwas schief gelaufen ist.
...
Eventuell hat man im eignen Betrieb auch gehört, dass andere Teams TDD erfolgreich in den Entwicklungsprozess integriert haben und nun überlegt man sich selbst dies zu tun.
